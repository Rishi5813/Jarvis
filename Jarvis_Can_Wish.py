...
# take_command() function to Take Command as a input and execute the command based on the conditional statements, Which start from the line 111 and can extended as much as possible.
def take_command():
    r = sr.Recognizer()
    with sr.Microphone()as source:
        print("Listening...")
